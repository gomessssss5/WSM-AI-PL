...
export const WelcomeCardModal: React.FC<WelcomeCardModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/75 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 select-none animate-in fade-in duration-300">
      <div 
        className="relative w-full max-w-md sm:max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden border border-[#eae6e1] flex flex-col max-h-[92vh] transform transition-all animate-in zoom-in-95 duration-300"
            ...
            <div className="space-y-3.5 animate-in fade-in duration-200">
              ...
              <div className="bg-gray-950 rounded-2xl p-2 border border-gray-800 flex items-center justify-center overflow-hidden">
                <img
                  ...
                  className="w-full h-auto max-h-[48vh] sm:max-h-[52vh] object-contain rounded-xl shadow-md"
                />
              </div>
            </div>
          ) : (
