...
export default function WriterDashboard({
  ...
  return (
    <div className="flex-1 bg-white flex flex-col items-center py-20 px-4 sm:px-8 font-sans overflow-y-auto">
      <div className="w-full max-w-4xl flex flex-col gap-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Área do Escritor</h1>
            <p className="text-gray-500 mt-2">Crie textos, redações e livros com a ajuda da IA como seu revisor e assistente criativo.</p>
          </div>
          <button
            onClick={onNewDocument}
            className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white px-5 py-2.5 rounded-xl font-bold shadow-md transition-all active:scale-95 cursor-pointer"
          >
