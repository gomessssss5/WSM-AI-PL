...
export const benchmark04CategoryData: Record<number, ModelScore[]> = {
  0: [
    ...
    { name: 'Omnix 1.6', score: 91.2, isWsm: true },
  ...
  1: [
    ...
    { name: 'Omnix 1.6', score: 89, isWsm: true },
  ...
  2: [
    ...
    { name: 'Omnix 1.6', score: 90, isWsm: true },
    { name: 'GPT-5.5', score: 90 },
  ...
  3: [
    { name: 'Claude Fable 5', score: 95 },
    { name: 'GPT-5.6 Sol', score: 94 },
    { name: 'Omnix 1.6', score: 93, isWsm: true },
  ...
  7: [
    ...
    { name: 'Omnix 1.6', score: 96, isWsm: true },
  ...
  9: [
    ...
    { name: 'DeepSeek V4 Pro', score: 85 },
    { name: 'Omnix 1.6', score: 83, isWsm: true },
    { name: 'Grok 4 Heavy', score: 83 },
  ...
  11: [
    { name: 'Omnix 1.6', score: 91, isWsm: true },
    { name: 'Claude Fable 5', score: 91 },
